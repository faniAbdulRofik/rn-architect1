  ...
  head: () => ({
    meta: [
      { title: "RN_ARCHITECT — Studio Arsitektur & Interior" },
      {
        name: "description",
        content:
          "Portofolio, layanan desain, dan katalog interior custom dari RN_ARCHITECT. Konsultasi langsung via WhatsApp.",
      },
      { property: "og:title", content: "RN_ARCHITECT — Studio Arsitektur & Interior" },
      { property: "og:description", content: "Ruang yang tenang, fungsional, dan tahan waktu." },
    ],
  }),
  component: HomePage,
});
  ...
  return (
    <SiteLayout>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        <img
          src={hero}
          alt="Interior arsitektural dengan latar bambu hijau"
          width={1920}
          height={1280}
        ...
        <div className="relative container mx-auto px-6 py-32 text-cream">
          ...
          <h1 className="reveal reveal-delay-1 font-display text-5xl md:text-7xl lg:text-8xl max-w-4xl text-balance leading-[1.05]">
            Ruang yang tenang, <em className="text-bamboo-soft not-italic">tahan waktu</em>.
          </h1>
          <p className="reveal reveal-delay-2 mt-6 max-w-xl text-cream/80 text-lg">
          ...
          <div className="reveal reveal-delay-4 mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-3xl">
            {stats.map((s) => (
              <div key={s.l}>
                ...
                <div className="text-xs uppercase tracking-widest text-cream/60 mt-1">{s.l}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-28 bg-gradient-warm">
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            ...
            sesaat. Hasilnya: arsitektur yang terasa familiar sejak hari pertama, dan tetap relevan
      ...
      <section className="py-28">
        <div className="container mx-auto px-6">
          <div className="flex flex-wrap items-end justify-between gap-6 mb-14">
            ...
            <Link to="/services" className="text-sm text-primary inline-flex items-center gap-1 hover:gap-2 transition-smooth">
      ...
      <section className="py-28 bg-secondary/40">
        <div className="container mx-auto px-6">
          <div className="flex flex-wrap items-end justify-between gap-6 mb-14">
            ...
            <Link to="/projects" className="text-sm text-primary inline-flex items-center gap-1 hover:gap-2 transition-smooth">
              Lihat semua <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { img: project1, title: "Bamboo Court House", meta: "Residensial · Bandung · 2024" },
              { img: project2, title: "Atelier Office", meta: "Komersial · Jakarta · 2023" },
            ].map((p) => (
              <article key={p.title} className="group overflow-hidden rounded-lg bg-card shadow-soft">
      ...
      <section className="py-28">
        <div className="container mx-auto px-6">
          <div className="flex flex-wrap items-end justify-between gap-6 mb-14">
            ...
            <Link to="/products" className="text-sm text-primary inline-flex items-center gap-1 hover:gap-2 transition-smooth">
              Lihat katalog <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { img: product1, title: "Meja Makan Solid Oak", tag: "Custom Available" },
              { img: product2, title: "Lemari Walnut 4 Pintu", tag: "Custom Available" },
              { img: product3, title: "Sofa Velvet Bamboo", tag: "Ready Stock" },
            ].map((p) => (
              <a
                key={p.title}
